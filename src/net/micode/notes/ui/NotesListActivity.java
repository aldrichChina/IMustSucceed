...
import net.micode.notes.util.BackupUtils;
import net.micode.notes.util.DataUtils;
import net.micode.notes.util.ResourceParser;
import net.micode.notes.view.widget.NoteWidgetProvider_2x;
import net.micode.notes.view.widget.NoteWidgetProvider_4x;
