...
import net.micode.notes.view.RoundImageView;
import net.micode.notes.view.UserPhotosView;
import net.micode.notes.view.UserPhotosView.onPagerPhotoItemClickListener;
