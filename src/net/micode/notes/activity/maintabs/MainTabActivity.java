...
public class MainTabActivity extends TabActivity {
	...
	private void initTabs() {
		...
		TabHost.TabSpec nearbyFeedsTabSpec = mTabHost.newTabSpec(NearByFeedsActivity.class.getName()).setIndicator(nearbyFeedsView);
		...
		TabHost.TabSpec contactTabSpec = mTabHost.newTabSpec(ContactTabsActivity.class.getName()).setIndicator(contactView);
		...
		TabHost.TabSpec userSettingTabSpec = mTabHost.newTabSpec(UserSettingActivity.class.getName()).setIndicator(userSettingView);
