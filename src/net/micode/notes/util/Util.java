 ...
 *    @version:    1.0.0
 *
 *    Create at:   2016年8月16日 下午4:12:51
 *
 *    Revision:
 *
 *    2016年8月16日 下午4:12:51
 *        - second revision
 *
 *****************************************************************/
package net.micode.notes.util;
...
public class Util {
    ...
    public static Properties collectDeviceInfo(Context context) {
        ...
        try {
            ...
            if (pi != null) {
                mDeviceCrashInfo.put(pinfo.versionName, pi.versionName == null ? "not set" : pi.versionName);
                mDeviceCrashInfo.put(pinfo.versionCode, pi.versionCode);
            }
        } catch (PackageManager.NameNotFoundException e) {
