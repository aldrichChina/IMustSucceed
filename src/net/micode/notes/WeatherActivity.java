...
/**
 * @author htq 爱丽颖的颖火虫 博客地址：blog.csdn.net/htq__
 */
public class WeatherActivity extends BaseActivity implements OnClickListener, FragmentAndActivity {
    ...
    private void getIntentData() {
        ...
        String wetherdata = ConstantProvider.weather_data;
    ...
    public void closeinput(EditText editText) {
        editText.setText("");
        InputMethodManager imm = (InputMethodManager) getSystemService(WeatherActivity.INPUT_METHOD_SERVICE);
